...
impl super::opcode::ViewBox {
    pub fn new<P0, P1, P2, P3>(minx: P0, miny: P1, width: P2, height: P3) -> Self
    where
        Number: From<P0>,
        Number: From<P1>,
        Number: From<P2>,
    ...
    {
        Self {
            minx: super::opcode::variable::Variable::Constant(Number::from(minx).0),
            miny: super::opcode::variable::Variable::Constant(Number::from(miny).0),
            width: super::opcode::variable::Variable::Constant(Number::from(width).0),
            height: super::opcode::variable::Variable::Constant(Number::from(height).0),
            aspect: None,
        }
    }
}
...
impl super::opcode::Canvas {
    pub fn new<P0, P1>(width: P0, height: P1) -> Self
    where
        super::opcode::Length: From<P0>,
        super::opcode::Length: From<P1>,
    {
        Self {
            width: super::opcode::variable::Variable::Constant(width.into()),
            height: super::opcode::variable::Variable::Constant(height.into()),
        }
    }
}
impl super::opcode::Canvas {
...
impl super::opcode::FeConvolveMatrix {
        ...
        bool: From<P2>,
    {
        Self {
            r#in: None,
            order: None,
            kernel: super::opcode::variable::Variable::Constant(kernel.map_collect()),
            divisor: None,
            bias: None,
            target_x: None,
            target_y: None,
...
impl super::opcode::Path {
    pub fn new<P0, P1>(events: P0, length: P1) -> Self
    where
        P0: MapCollect<super::opcode::PathEvent>,
        super::opcode::Length: From<P1>,
    {
        Self {
            events: super::opcode::variable::Variable::Constant(events.map_collect()),
            length: super::opcode::variable::Variable::Constant(length.into()),
        }
    }
}
impl super::opcode::Path {
...
impl super::opcode::Rect {
        ...
        super::opcode::Length: From<P3>,
    {
        Self {
            ...
            y: super::opcode::variable::Variable::Constant(y.into()),
            width: super::opcode::variable::Variable::Constant(width.into()),
            height: super::opcode::variable::Variable::Constant(height.into()),
            rx: None,
            ry: None,
...
impl super::opcode::Circle {
    pub fn new<P0, P1, P2>(cx: P0, cy: P1, r: P2) -> Self
    where
        super::opcode::Length: From<P0>,
        super::opcode::Length: From<P1>,
        super::opcode::Length: From<P2>,
    {
        Self {
            cx: super::opcode::variable::Variable::Constant(cx.into()),
            cy: super::opcode::variable::Variable::Constant(cy.into()),
            r: super::opcode::variable::Variable::Constant(r.into()),
        }
    }
}
impl super::opcode::Circle {
...
impl super::opcode::Ellipse {
    pub fn new<P0, P1>(rx: P0, ry: P1) -> Self
    where
        super::opcode::Length: From<P0>,
        super::opcode::Length: From<P1>,
    {
        Self {
            cx: None,
            cy: None,
            rx: super::opcode::variable::Variable::Constant(rx.into()),
            ry: super::opcode::variable::Variable::Constant(ry.into()),
        }
    }
}
impl super::opcode::Ellipse {
...
impl super::opcode::Line {
    ...
    {
        Self {
            x1: super::opcode::variable::Variable::Constant(x1.into()),
            y1: super::opcode::variable::Variable::Constant(y1.into()),
            x2: super::opcode::variable::Variable::Constant(x2.into()),
            y2: super::opcode::variable::Variable::Constant(y2.into()),
        }
    }
}
impl super::opcode::Line {
