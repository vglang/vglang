...
pub struct TextLayout {
    ...
    pub anchor: Option<variables::Variable<TextAnchor>>,
    pub dominant_baseline: Option<variables::Variable<DominantBaseline>>,
    pub alignment_baseline: Option<variables::Variable<AlignmentBaseline>>,
    pub baseline_shift: Option<variables::Variable<BaselineShift>>,
    pub decoration: Option<variables::Variable<TextDecoration>>,
    pub letter_spacing: Option<variables::Variable<LetterSpacing>>,
    pub word_spacing: Option<variables::Variable<WordSpacing>>,
}
#[doc = "support for various international writing directions, such as left-to-right (e.g., Latin scripts) and"]
#[doc = "bidirectional (e.g., Hebrew or Arabic) and vertical (e.g., Asian scripts)."]
#[derive(Debug, PartialEq, PartialOrd, Clone)]
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Stroke {
    pub paint: Option<variables::Variable<Paint>>,
    pub width: Option<variables::Variable<Length>>,
    pub linecap: Option<variables::Variable<StrokeLineCap>>,
    pub linejoin: Option<variables::Variable<StrokeLineJoin>>,
    pub dasharray: Option<variables::Variable<Vec<Length>>>,
    pub dashoffset: Option<variables::Variable<Length>>,
}
#[doc = "Shorthand property for setting ‘font-style’, ‘font-variant’, ‘font-weight’, ‘font-size’, ‘line-height’ and ‘font-family’."]
#[derive(Debug, PartialEq, PartialOrd, Clone)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Font {
    pub family: Option<variables::Variable<Vec<FontFamily>>>,
    pub style: Option<variables::Variable<FontStyle>>,
    pub variant: Option<variables::Variable<FontVariant>>,
    pub weight: Option<variables::Variable<FontWeight>>,
    pub size: Option<variables::Variable<Length>>,
    pub stretch: Option<variables::Variable<FontStretch>>,
}
...
pub struct ViewBox {
    ...
    pub width: f32,
    pub height: f32,
    pub aspect: Option<variables::Variable<PreserveAspectRatio>>,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Mask {
    pub units: Option<variables::Variable<Coords>>,
    pub content_units: Option<variables::Variable<Coords>>,
    pub x: Option<variables::Variable<Length>>,
    pub y: Option<variables::Variable<Length>>,
    pub width: Option<variables::Variable<Length>>,
    pub height: Option<variables::Variable<Length>>,
}
...
#[derive(Debug, PartialEq, PartialOrd, Clone)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct ClipPath(pub Option<variables::Variable<Coords>>);
...
pub struct Filter {
    pub units: Option<variables::Variable<Coords>>,
    pub primitive_units: Option<variables::Variable<Coords>>,
    pub x: Option<variables::Variable<Length>>,
    pub y: Option<variables::Variable<Length>>,
    pub width: Option<variables::Variable<Length>>,
    pub height: Option<variables::Variable<Length>>,
    pub res: Option<variables::Variable<NumberOptNumber>>,
}
...
pub struct FeDistantLight {
    pub azimuth: Option<variables::Variable<f32>>,
    pub elevation: Option<variables::Variable<f32>>,
}
...
pub struct FePointLight {
    pub x: Option<variables::Variable<f32>>,
    pub y: Option<variables::Variable<f32>>,
    pub z: Option<variables::Variable<f32>>,
}
...
pub struct FeSpotLight {
    ...
    pub y: Option<variables::Variable<f32>>,
    pub z: Option<variables::Variable<f32>>,
    pub point_at_x: Option<variables::Variable<f32>>,
    pub point_at_y: Option<variables::Variable<f32>>,
    pub point_at_z: Option<variables::Variable<f32>>,
    pub specular_exponent: Option<variables::Variable<f32>>,
    pub limiting_cone_angle: Option<variables::Variable<f32>>,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct FeBlend {
    pub mode: Option<variables::Variable<FeBlendMode>>,
    pub r#in: Option<variables::Variable<FeIn>>,
    pub in2: Option<variables::Variable<FeIn>>,
}
...
#[derive(Debug, PartialEq, PartialOrd, Clone)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct FeComponentTransfer(pub Option<variables::Variable<FeIn>>);
...
pub struct FeComposite {
    pub r#in: Option<variables::Variable<FeIn>>,
    pub in2: FeIn,
    pub operator: Option<variables::Variable<FeCompositeOperator>>,
}
...
pub struct FeConvolveMatrix {
    pub r#in: Option<variables::Variable<FeIn>>,
    pub order: Option<variables::Variable<NumberOptNumber>>,
    pub kernel: Vec<f32>,
    pub divisor: Option<variables::Variable<f32>>,
    pub bias: Option<variables::Variable<f32>>,
    pub target_x: Option<variables::Variable<i32>>,
    pub target_y: Option<variables::Variable<i32>>,
    pub edge_mode: FeConvolveMatrixEdgeMode,
    pub kernel_unit_len: Option<variables::Variable<NumberOptNumber>>,
...
pub struct FeDiffuseLighting {
    pub r#in: FeIn,
    pub surface_scale: Option<variables::Variable<f32>>,
    pub diffuse_constant: Option<variables::Variable<f32>>,
    pub kernel_unit_len: Option<variables::Variable<NumberOptNumber>>,
}
...
pub struct FeDisplacementMap {
    pub r#in: Option<variables::Variable<FeIn>>,
    pub in2: FeIn,
    pub scale: Option<variables::Variable<f32>>,
    pub x_channel_selector: Option<variables::Variable<Channel>>,
    pub y_channel_selector: Option<variables::Variable<Channel>>,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct FeFlood {
    pub color: Option<variables::Variable<Rgb>>,
    pub opacity: Option<variables::Variable<f32>>,
}
...
pub struct FeGaussianBlur {
    pub r#in: Option<variables::Variable<FeIn>>,
    pub std_deviation: Option<variables::Variable<NumberOptNumber>>,
}
...
pub struct FeMorphology {
    pub r#in: Option<variables::Variable<FeIn>>,
    pub mode: Option<variables::Variable<FeMorphologyOperator>>,
    pub radius: Option<variables::Variable<NumberOptNumber>>,
}
...
pub struct FeOffset {
    pub r#in: Option<variables::Variable<FeIn>>,
    pub dx: Option<variables::Variable<f32>>,
    pub dy: Option<variables::Variable<f32>>,
}
...
pub struct FeSpecularLighting {
    pub r#in: Option<variables::Variable<FeIn>>,
    pub surface_scale: Option<variables::Variable<f32>>,
    pub specular_constant: Option<variables::Variable<f32>>,
    pub specular_exponent: Option<variables::Variable<f32>>,
    pub kernel_unit_len: Option<variables::Variable<NumberOptNumber>>,
}
...
pub struct FeTurbulence {
    pub base_frequency: Option<variables::Variable<NumberOptNumber>>,
    pub num_octaves: Option<variables::Variable<i32>>,
    pub seed: Option<variables::Variable<f32>>,
    pub stitch_tiles: Option<variables::Variable<FeStitchTiles>>,
    pub r#type: Option<variables::Variable<FeTurbulenceType>>,
}
...
pub struct LinearGradient {
    pub units: Option<variables::Variable<Coords>>,
    pub transform: Option<variables::Variable<Transform>>,
    pub x1: Option<variables::Variable<Length>>,
    pub y1: Option<variables::Variable<Length>>,
    pub x2: Option<variables::Variable<Length>>,
    pub y2: Option<variables::Variable<Length>>,
    pub spread: Option<variables::Variable<SpreadMethod>>,
}
#[doc = "Radial gradients are defined by a ‘radialGradient’ element."]
#[derive(Debug, PartialEq, PartialOrd, Clone)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct RadialGradient {
    pub unit: Option<variables::Variable<Coords>>,
    pub transform: Option<variables::Variable<Transform>>,
    pub cx: Option<variables::Variable<Length>>,
    pub cy: Option<variables::Variable<Length>>,
    pub r: Option<variables::Variable<Length>>,
    pub fx: Option<variables::Variable<Length>>,
    pub fy: Option<variables::Variable<Length>>,
    pub spread: Option<variables::Variable<SpreadMethod>>,
}
...
pub struct Rect {
    ...
    pub width: Length,
    pub height: Length,
    pub rx: Option<variables::Variable<Length>>,
    pub ry: Option<variables::Variable<Length>>,
}
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct TextPath {
    pub start_offset: Option<variables::Variable<Length>>,
    pub method: Option<variables::Variable<TextPathMethod>>,
    pub spacing: Option<variables::Variable<TextPathSpacing>>,
    pub href: Iri,
}
#[doc = r" the data types that can be passed to the animation registers."]
