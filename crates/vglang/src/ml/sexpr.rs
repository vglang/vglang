...
impl super::opcode::Fill {
    ...
    {
        self.rule = Some(super::opcode::variable::Variable::Constant(value.into()));
        self
    }
}
impl super::opcode::Fill {
    ...
    super::opcode::Length: From<Fy>,
{
    fn from(value: (Cx, Cy, R, Fx, Fy)) -> Self {
        Self {
            unit: None,
            transform: None,
            cx: Some(super::opcode::variable::Variable::Constant(value.0.into())),
            cy: Some(super::opcode::variable::Variable::Constant(value.1.into())),
            r: Some(super::opcode::variable::Variable::Constant(value.2.into())),
            fx: Some(super::opcode::variable::Variable::Constant(value.3.into())),
            fy: Some(super::opcode::variable::Variable::Constant(value.4.into())),
            spread: None,
        }
    }
}
    ...
    Events: MapCollect<super::opcode::PathEvent>,
{
    fn from(value: Events) -> Self {
        Self {
            events: super::opcode::variable::Variable::Constant(value.map_collect()),
            length: None,
        }
    }
}
...
impl super::opcode::Path {
    ...
    where
        super::opcode::Length: From<T>,
    {
        self.length = Some(super::opcode::variable::Variable::Constant(value.into()));
        self
    }
}
...
where
    ...
    super::opcode::FontFamily: From<P37>,
    super::opcode::FontFamily: From<P38>,
    super::opcode::FontFamily: From<P39>,
{
    fn map_collect(self) -> Vec<super::opcode::FontFamily> {
        vec![
            self.0.into(),
...
where
    ...
    super::opcode::PathEvent: From<P37>,
    super::opcode::PathEvent: From<P38>,
    super::opcode::PathEvent: From<P39>,
{
    fn map_collect(self) -> Vec<super::opcode::PathEvent> {
        vec![
            self.0.into(),
...
where
    ...
    super::opcode::Transform: From<P37>,
    super::opcode::Transform: From<P38>,
    super::opcode::Transform: From<P39>,
{
    fn map_collect(self) -> Vec<super::opcode::Transform> {
        vec![
            self.0.into(),
...
where
    ...
    super::opcode::FontFamily: From<P38>,
    super::opcode::FontFamily: From<P39>,
    super::opcode::FontFamily: From<P40>,
{
    fn map_collect(self) -> Vec<super::opcode::FontFamily> {
        vec![
            self.0.into(),
...
where
    ...
    super::opcode::PathEvent: From<P38>,
    super::opcode::PathEvent: From<P39>,
    super::opcode::PathEvent: From<P40>,
{
    fn map_collect(self) -> Vec<super::opcode::PathEvent> {
        vec![
            self.0.into(),
...
where
    ...
    super::opcode::Transform: From<P38>,
    super::opcode::Transform: From<P39>,
    super::opcode::Transform: From<P40>,
{
    fn map_collect(self) -> Vec<super::opcode::Transform> {
        vec![
            self.0.into(),
    ...
    Number: From<P79>,
{
    fn map_collect(self) -> Vec<super::opcode::Point> {
        vec![
            ...
            super::opcode::Point(Number::from(self.74).0, Number::from(self.75).0),
            super::opcode::Point(Number::from(self.76).0, Number::from(self.77).0),
            super::opcode::Point(Number::from(self.78).0, Number::from(self.79).0),
        ]
    }
}
impl<
    ...
    Number: From<P81>,
{
    fn map_collect(self) -> Vec<super::opcode::Point> {
        vec![
            ...
            super::opcode::Point(Number::from(self.76).0, Number::from(self.77).0),
            super::opcode::Point(Number::from(self.78).0, Number::from(self.79).0),
            super::opcode::Point(Number::from(self.80).0, Number::from(self.81).0),
        ]
    }
}
