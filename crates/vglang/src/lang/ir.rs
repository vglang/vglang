...
#[derive(Debug, PartialEq, PartialOrd, Clone)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct NamedRegister(pub Span, pub Ident);
...
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct CallExpr {
    /// the whole span of this call.
    pub span: Span,
    /// Attribute list for this call.
    pub attrs: Vec<Attr>,
    /// The main part of this call.
    pub body: CallBody,
    /// May have a trailing closure.
    pub trailing: Option<Block>,
}

/// A graphic function declaration.
#[derive(Debug, PartialEq, PartialOrd, Clone)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Fn {
    /// the whole span of this fn declaration.
    pub span: Span,
    /// The name of this function.
    pub name: Ident,
    /// argument list of this function signature.
    pub args: Vec<FnArg>,
    /// function body
    pub body: Block,
}

/// Fn argument declaration.
#[derive(Debug, PartialEq, PartialOrd, Clone)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct FnArg {
    /// the whole span of this fn declaration.
...
pub enum Type {
    /// A color value.
    Color,
    /// A trailing closure declaration.
    ///
    /// Trailing closures can only appear at the end of the argument list.
    Closure,
}

/// A braced block containing vglang statements: `{ .. codes... }`
#[derive(Debug, PartialEq, PartialOrd, Clone)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub struct Block {
    /// the whole span of this call body.
...
/// Varint for vglang statements.
#[derive(Debug, PartialEq, PartialOrd, Clone)]
#[cfg_attr(feature = "serde", derive(serde::Serialize, serde::Deserialize))]
pub enum Stat {
    /// A fn declaration.
    Fn(Fn),
    /// A graphic fn calling.
    Call(CallExpr),
}
