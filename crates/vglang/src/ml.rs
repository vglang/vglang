...
pub mod sexpr {
    ...
    impl super::opcode::TextLayout {
            ...
            super::opcode::DominantBaseline: From<T>,
        {
            self.dominant_baseline =
                Some(super::opcode::variable::Variable::Constant(value.into()));
            self
        }
    }
    impl super::opcode::TextLayout {
    ...
    impl<P0, P1, P2> From<(P0, P1, P2)> for super::opcode::Fill
    where
        super::opcode::Paint: From<P0>,
        super::opcode::FillRule: From<P1>,
        Number: From<P2>,
    {
        fn from(value: (P0, P1, P2)) -> Self {
            Self {
    ...
    impl super::opcode::Fill {
        ...
        where
            Number: From<T>,
        {
            self.opacity = Number::from(value).0;
            self
        }
    }
    ...
    impl<P0> From<P0> for super::opcode::FeBlend
    where
        super::opcode::Length: From<P0>,
    {
        fn from(value: P0) -> Self {
            Self {
                ...
                r#in: None,
                in2: None,
                x: super::opcode::variable::Variable::Constant(value.into()),
                y: None,
                width: None,
                height: None,
                result: None,
    ...
    impl<P0, P1, P2> From<(P0, P1, P2)> for super::opcode::FeColorMatrix
    where
        ...
        super::opcode::Length: From<P2>,
    {
        fn from(value: (P0, P1, P2)) -> Self {
            Self {
                ...
                x: super::opcode::variable::Variable::Constant(value.2.into()),
                y: None,
                width: None,
                height: None,
                result: None,
    ...
    impl<P0, P1> From<(P0, P1)> for super::opcode::FeComposite
    where
        super::opcode::FeIn: From<P0>,
        super::opcode::Length: From<P1>,
    {
        fn from(value: (P0, P1)) -> Self {
            Self {
                r#in: None,
                in2: super::opcode::variable::Variable::Constant(value.0.into()),
                operator: None,
                x: super::opcode::variable::Variable::Constant(value.1.into()),
                y: None,
                width: None,
                height: None,
                result: None,
    ...
    impl<P0, P1, P2, P3> From<(P0, P1, P2, P3)> for super::opcode::FeConvolveMatrix
    where
        P0: MapCollect<f32>,
        ...
        super::opcode::Length: From<P3>,
    {
        fn from(value: (P0, P1, P2, P3)) -> Self {
            Self {
                ...
                x: super::opcode::variable::Variable::Constant(value.3.into()),
                y: None,
                width: None,
                height: None,
                result: None,
    ...
    impl<P0, P1> From<(P0, P1)> for super::opcode::FeDiffuseLighting
    where
        super::opcode::FeIn: From<P0>,
        super::opcode::Length: From<P1>,
    {
    ...
    impl<P0, P1> From<(P0, P1)> for super::opcode::FeDisplacementMap
    where
        super::opcode::FeIn: From<P0>,
        super::opcode::Length: From<P1>,
    {
    ...
    impl<P0> From<P0> for super::opcode::FeFlood
    where
        super::opcode::Length: From<P0>,
    {
        fn from(value: P0) -> Self {
    ...
    impl<P0> From<P0> for super::opcode::FeGaussianBlur
    where
        super::opcode::Length: From<P0>,
    {
        fn from(value: P0) -> Self {
    ...
    impl<P0> From<P0> for super::opcode::FeMerge
    where
        super::opcode::Length: From<P0>,
    {
        fn from(value: P0) -> Self {
    ...
    impl<P0, P1> From<(P0, P1)> for super::opcode::FeImage
    where
        super::opcode::FuncIri: From<P0>,
        super::opcode::Length: From<P1>,
    {
        fn from(value: (P0, P1)) -> Self {
            Self {
                href: super::opcode::variable::Variable::Constant(value.0.into()),
                aspect: None,
                x: super::opcode::variable::Variable::Constant(value.1.into()),
                y: None,
                width: None,
    ...
    impl<P0> From<P0> for super::opcode::FeMorphology
    where
        super::opcode::Length: From<P0>,
    {
        fn from(value: P0) -> Self {
    ...
    impl<P0> From<P0> for super::opcode::FeOffset
    where
        super::opcode::Length: From<P0>,
    {
        fn from(value: P0) -> Self {
    ...
    impl<P0> From<P0> for super::opcode::FeSpecularLighting
    where
        super::opcode::Length: From<P0>,
    {
        fn from(value: P0) -> Self {
    ...
    impl<P0> From<P0> for super::opcode::FeTile
    where
        super::opcode::Length: From<P0>,
    {
        fn from(value: P0) -> Self {
    ...
    impl<P0> From<P0> for super::opcode::FeTurbulence
    where
        super::opcode::Length: From<P0>,
    {
        fn from(value: P0) -> Self {
