...
pub fn rect_02() -> impl Graphics {
    Canvas::from((12.cm(), 4.cm()))
        ...
        .children((
            Rect::from((1, 1, 1198, 398))
                .apply((Fill::from(Paint::None), Stroke::from(Color::Blue))),
            Rect::from((100, 100, 400, 200)).rx(50).apply((
            ...
            Group
                ...
                .children(Rect::from((0, 0, 400, 200)).rx(50).apply((
                    Fill::from(Paint::None),
                    Stroke::from(Color::Purple).width(30),
                ))),
        ))
}
    ...
    Canvas::from((12.cm(), 4.cm()))
        ...
        .children((
            ...
            Group
                ...
                .children(Ellipse::from((250, 100)).apply(Fill::from(Color::Red))),
            Ellipse::from((250, 100)).apply((
                WithTransform::from(((900, 200).translate(), (-30).rotate())),
                Fill::from(Paint::None),
                Stroke::from(Color::Blue).width(30),
            )),
        ))
}
...
pub fn polyline_01() -> impl Graphics {
    Canvas::from((12.cm(), 4.cm()))
        ...
        .children((
            ...
            .apply((Fill::from(Paint::None), Stroke::from(Color::Blue).width(10))),
        ))
}
